...
import { Home, Compass, Map, BookOpen } from "lucide-react";
        ...
        {navItems.map((item) => {
          ...
          return (
            <Link
              ...
              href={item.href}
              className={cn(
                "flex min-h-[56px] min-w-[64px] flex-col items-center justify-center gap-0.5 px-3 py-2 text-xs transition-colors",
                "active:scale-95",
                isActive
