...
const FAQS: Faq[] = [
  {
    ...
    a: "두 가지 자료를 씁니다. ① 계열별 추천 과목의 뼈대는 각 학교가 올린 편제표와 「2022 개정 교육과정 선택 과목 안내서」입니다. ② 각 과목이 대학에서 얼마나 요구되는지는 한국대학교육협의회(대교협)가 발표한 「2028학년도 권역별 대학별 권장과목」(전국 47개 대학)과 대조해 확인합니다. 두 자료를 교차 검증해, 안내서가 추천하지만 대학 요구 근거가 없는 과목과 대학이 요구하지만 빠진 과목을 점검했습니다.",
  },
  {
