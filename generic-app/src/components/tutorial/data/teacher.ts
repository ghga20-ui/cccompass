...
export const teacherTutorial: TutorialDef = {
  ...
  steps: [
    ...
    },
    {
      ...
      title: "붙은 과목 나누기",
      coachTip:
        "지정 과목은 과목명·학점을 바로 고칠 수 있어요. ‘정보한문’처럼 두 과목이 붙어 들어왔다면 ‘과목 나누기’로 분리하세요. 한번 눌러볼게요.",
      target: "splitBtn",
      arrow: "left",
      interactive: true,
      action: "‘과목 나누기’ 클릭",
    },
    {
      ...
      title: "선택군(택N)·집중이수 설정",
      coachTip:
        "학생이 고르는 묶음은 ‘선택군 추가’로 만들고 택1·택3처럼 택N을 지정해요. 학기를 번갈아 배우는 과목은 ↔(집중이수)로 학기를 배정합니다. 우리 학교 편제 그대로 반영되는 핵심이에요.",
      target: "addGroupBtn",
      arrow: "left",
      interactive: true,
      action: "‘선택군 추가’ 클릭",
